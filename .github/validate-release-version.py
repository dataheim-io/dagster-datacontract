...
`dagster_datacontract-0.1.2` must match the prefix of the files in the `dist/` folder:
...
USAGE
    ...
    $ python .github/validate-release-version.py libraries/dagster_datacontract-delta/dist dagster_datacontract-0.1.3
